...
def createpost(request):
        if request.method == 'POST':
            if request.POST.get('fname') and request.POST.get('lname')and request.POST.get('country')and request.POST.get('subject'):
                post=form()
...
def contactform(request):
    if request.method == 'POST':
        ...
        ins = form(fname=fname,lname=lname,country=country,subject=subject)
        ins.save()
